...
#define ARMOR_BIG_WIDTH 229 / 2
#define ARMOR_BIG_HEIGHT 125 / 2 / 2
#else
#define ARMOR_BIG_WIDTH 229 / 2
#define ARMOR_BIG_HEIGHT 125 / 2
#endif
    ...
    {
#if USE_LIGHTBAR_P4P_POINTS
#define ARMOR_SMALL_WIDTH 135 / 2
#define ARMOR_SMALL_HEIGHT 125 / 2 / 2
#else
#define ARMOR_SMALL_WIDTH 135 / 2
#define ARMOR_SMALL_HEIGHT 125 / 2
#endif
...
#define RUNE_WING_HEIGHT RUNE_WING_WIDTH / 2                 // 68.75
    ...
    void Solve::Solve_Armor(std::vector<cv::Point2f> OBJECT_2D)
    {
        ...
        _CAM_MATRIX.at<double>(0,0) = 2077.6;
        _CAM_MATRIX.at<double>(0,1) = 0.0000000000000000;
        _CAM_MATRIX.at<double>(0,2) = 620.9167;
        _CAM_MATRIX.at<double>(1,0) = 0.0000000000000000;
        _CAM_MATRIX.at<double>(1,1) = 2076.4;
        _CAM_MATRIX.at<double>(1,2) = 498.1369;
        ...
        _DISTORTION_COEFF.at<double>(0,0) = -0.0820;
        _DISTORTION_COEFF.at<double>(1,0) = 0.5396;
        _DISTORTION_COEFF.at<double>(2,0) = 0.0000000000000000;
        _DISTORTION_COEFF.at<double>(3,0) = 0.0000000000000000;
        _DISTORTION_COEFF.at<double>(4,0) = -0.9800;
